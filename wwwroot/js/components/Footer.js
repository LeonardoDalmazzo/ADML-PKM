...
(function () {
  class Footer {
    ...
    render() {
      ...
      // fallback simples caso alguÃ©m esqueÃ§a de importar LinkIcon
      ...
      const hubLinks = [
        ...
        { href: `${rp}pages/programacao/index.html`, label: "Programação", icon: "link", newTab: false },
        ...
        <div class="app-footer">
          <div class="footer-grid">
            ...
            <section class="footer-col">
              ...
              <nav class="footer-links" aria-label="Navegação do rodapÃ©">
